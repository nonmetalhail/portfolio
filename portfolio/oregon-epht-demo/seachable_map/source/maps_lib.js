...
var MapsLib = {
  ...
  fusionTableId:      "13mVeS33wiaGi1pozYvs3bxyfyQloTigOGhKAiHY",  
  
  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/      
  googleApiKey:       "AIzaSyAm9yWCV7JPCTHCJut8whOjARd7pwROFDQ",        
  
  locationColumn:     "latitude",     //name of the location column in your Fusion Table
  map_centroid:       new google.maps.LatLng(44.2, -120.8), //center that your map defaults to
  locationScope:      "oregon",      //geographical area appended to all address searches
  ...
  doSearch: function(location) {
    ...
    // var searchType = "STATE IN (-1,";
    // if ( $("#cbType1").is(':checked')) searchType += "OR,";
